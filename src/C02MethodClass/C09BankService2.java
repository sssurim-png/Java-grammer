 ...
 */
public class C09BankService2 {
    public static void main(String[] args) {
        Map<String, BankAccount2> bankAccountMap = new HashMap<>();
        while (true){
...
//                계좌개설
                ...
                if(bankAccountMap.containsKey(accountNumber)){
                    ...
                    bankAccountMap.put(accountNumber, new BankAccount2(name, accountNumber, balance));
                }
            }else if (number==2){
//                계좌조회
                System.out.print("2. 계좌조회서비스입니다.계좌번호를 입력해주세요. : ");
                String accountNumber = sc.nextLine();
                BankAccount2 b1 = bankAccountMap.get(accountNumber);
                ...
                long money = Long.parseLong(sc.nextLine());
                BankAccount2 b1 = bankAccountMap.get(myNumber);
                BankAccount2 b2 = bankAccountMap.get(targetNumber);
                if(b1.checkBalance(money)){
...
class BankAccount2{
    ...
    public BankAccount2( String name, String accountNumber, long balance) {
        staticId++;
        this.id=staticId;
        this.name = name;
    ...
    public void transfer(BankAccount2 targetAccount, long money){
        if(this.balance < money){
            return;
        }
        this.balance -= money;
